	...
	<div class="signin-form">
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="pass" placeholder="Someone..." autocomplete="off" required>
			</div>
		...
		<div class="text-center small" style="color: #67428B;">Back to Signin? <a href="signup.php">Click here</a></div>
	</div>
	<?php
     ...
     include("include/connection.php");
        ...
        if(isset($_POST['submit'])){
          ...
          $select="select * from users where user_email='$email" AND forgetten_answer='$recovery_account'";
